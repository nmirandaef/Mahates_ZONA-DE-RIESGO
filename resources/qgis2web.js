...
map.getView().fit([-8369564.275487, 1145352.718106, -8369443.288480, 1145425.796187], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">UntitledCloudProject_MEJOR_ASI (QFieldCloud)</h2>';
        return titleElement;
    })(),
